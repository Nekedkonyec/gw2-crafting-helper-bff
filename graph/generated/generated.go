...
type ComplexityRoot struct {
	...
	Query struct {
		ListItems func(childComplexity int, id string) int
	}
}

type QueryResolver interface {
	ListItems(ctx context.Context, id string) ([]*model.Item, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.listItems":
		...
		return e.complexity.Query.ListItems(childComplexity, args["id"].(string)), true
...
func (ec *executionContext) _Item_icon(ctx context.Context, field graphql.CollectedField, obj *model.Item) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_listItems(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().ListItems(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNItem2ᚕᚖgithubᚗcomᚋnekedkonyecᚋgw2ᚑcraftingᚑhelperᚑbffᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Item(ctx context.Context, sel ast.SelectionSet, obj *model.Item) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "icon":
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Item_icon(ctx, field, obj)
			}
...
func (ec *executionContext) marshalNItem2ᚕᚖgithubᚗcomᚋnekedkonyecᚋgw2ᚑcraftingᚑhelperᚑbffᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖgithubᚗcomᚋnekedkonyecᚋgw2ᚑcraftingᚑhelperᚑbffᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNItem2ᚖgithubᚗcomᚋnekedkonyecᚋgw2ᚑcraftingᚑhelperᚑbffᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
